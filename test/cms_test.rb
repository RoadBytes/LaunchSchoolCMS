...
class CMSTest < Minitest::Test
  ...
  def test_editing_markdown_document_signed_in
    create_document 'markdown.md', '# Ruby is...'
  ...
  def test_editing_markdown_document_not_signed_in
    create_document 'markdown.md', '# Ruby is...'
    ...
    assert_equal 302, last_response.status
    refute_includes last_response.body, 'Edit content for markdown.md'
  end

  def test_updating_markdown_document_signed_in
    create_document 'temp.md', '# Ruby is...'

    post '/temp.md/edit', { content: 'new content' }, admin_session
  ...
  def test_updating_markdown_document_not_signed_in
    create_document 'temp.md', '# Ruby is...'
  ...
  def test_get_new_file_signed_in
  ...
  def test_get_new_file_not_signed_in
    get '/new'
  ...
  def test_post_new_file_signed_in
    post '/new', { new_filename: 'new.md' }, admin_session
  ...
  def test_post_new_file_not_signed_in
  ...
  def test_delete_documents_signed_in
  ...
  def test_delete_documents_not_signed_in
    create_document 'to_be_deleted.txt'
